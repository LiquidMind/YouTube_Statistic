...
import "./ChannelsItem.css";
const ChannelItemVideos = ({ channel, index }) => {
  let statusStyle = {};
  let statusIcon = null;
  ...
  return (
    <tr>
      ...
      <td>
        old: {channel.prev_view_count}
        <br />
        new: {channel.view_count}
        <br />
        diff: {channel.view_count - channel.prev_video_count}
      </td>
...
export default ChannelItemVideos;
