...
// const readline = require("readline");
// const { db } = require("../../model/dbConnection");
// const credentials = require("../client_secret"); // Змініть шлях до файлу credentials
...
//     TOKEN_PATH = TOKEN_DIR + `${resEmail}.json`;

//     console.log(TOKEN_PATH);

//     // Тут використовуються облікові дані безпосередньо з зовнішнього модуля
//     const clientSecret = credentials.installed.r;
//     const clientId = credentials.installed.client_id;
//     const redirectUrl = credentials.installed.redirect_uris[0];
//     const oauth2Client = new OAuth2(clientId, clientSecret, redirectUrl);
