...
async function frequency(objWords) {
  ...
  try {
    ...
    processFile(
      stemsFilePath,
      "/Users/andrijkozevnikov/Documents/ProjectYoutube/Archive/users_wordFolder/wordAndIndexInFolders",
      fileName
    );
    ...
    processFile(
      wordsFilePath,
      "/Users/andrijkozevnikov/Documents/ProjectYoutube/Archive/users_wordFolder/wordWoleAndIndexInFolders",
      fileName
    );
